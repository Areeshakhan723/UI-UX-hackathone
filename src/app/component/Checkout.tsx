...
import { createOrderAction } from "./actions/createOrder"; // ✅ Import server action
import { Order } from "./actions/createOrder"; // Import order type
...
const Checkout = () => {
  ...
  const handleEvent = async () => {
    ...
    const OrderData: Order = {
      ...
      city: formData.city,
      postalCode: formData.postalCode || "", // Handle empty postal code
    ...
    const result = await createOrderAction(OrderData); // ✅ Call server action
    ...
    if (result.success) {
      ...
      console.error("Sanity submission error:", result.error);
      Swal.fire({
        position: "center",
        icon: "error",
